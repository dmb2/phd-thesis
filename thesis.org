...
potential \cite{Townsend:2000modern} \cite{Griffiths:2008zz}. Rather
than re-derive the entire system, a brief review of the important
results are presented. The content of this section follows that of
\cite{Ellis:1991qj}. The existence of a solution is due to the
