...
three authors shared the Nobel Prize for Physics in 2004.]
...
eletromagnetically bound state of a positron and electron. Many of the
...
particle propogates it emits collinear gluon radiation according to a
...
apparatus, the methods of reconstructing jets and J/\psi candidates are 
...
hydrogen-like wave-functions as a basis and applying perturbation
...
to the persistency of this name versus the "spin-alignment
...
interchangably. ]." There have been many attempts at explaining the
...
** Hadronization
The partons produced during the shower must form hadrons which is an
...
and the magnet ceases to super conduct \cite{lhc-machine}. This transition
...
and 25 m tall[fn:: The detector weighs approximately 7000 tonnes. If
...
of Brehmsstrahlung, ionize the surrounding matter, or interact with
...
detector and \acrshort{sct} function based on semi-conductor technologies that
...
and the calorimeter measures the momentum of particles. The location
...
subsystems are the outer most portion of ATLAS. Portions of the
...
approach beginning from the \acrshort{trt} working backwards
...
associated to the tracks, the inside-out sequence is halted.
...
that can be done as they are the first selection on the collision events.
...
Conversely, a large probability of being signal (and small probability
