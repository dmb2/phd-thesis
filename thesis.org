...
research into the atomic bomb.] of a process ($\sigma(pp\rightarrow A
B)$ where $A$ and $B$ are outgoing particle species), the rate of
particles produced is given by the product of the luminosity and the
cross section:
#+BEGIN_LaTeX
\begin{equation*}
...
ellipse. Together they describe the effective area of the beam at the
IP.
* The ATLAS detector
** Inner Detector
*** Pixel Detector
