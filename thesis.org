...
#+CAPTION: The geometry of CSC chambers at ATLAS \ref{atlas-detector}.
...
iteratively following tracks back to a common point and assigning
spatial coordinates to this vertex. The procedure is repeated until no
further vertices can be created. 
