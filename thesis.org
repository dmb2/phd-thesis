...
#+CAPTION: As a charged particle ionizes the gas inside the straw tube, charge is collected over time as shown in the blue profiles.  When the particle passes closer to the anode the profile of the deposited charge changes \cite{trt-thesis}.
