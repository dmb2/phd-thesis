...
that Chapter \ref{chap:detector} describes the LHC and ATLAS detector
in detail. After describing the detecting apparatus, the methods of
reconstructing jets and J/\psi candidates is described in
Chapter \ref{chap:reconstruction}. With a firm grasp of the theory and
...
and future work follows in Chapter \ref{chap:conclusion}.
...
modeling this shape.  The comparison of the reconstructed Jet $p_T$
and $J/\psi$ $p_T$ are shown in Figures \ref{fig:jet_pt-sbs-p8} and
\ref{fig:jpsi_pt-sbs-p8}. 
...
Finally, this work provides new observables that may constrain the
...
plasma produced in those interactions. Having a new understand of how
the quarkonium bound state is produced may require reinterpreting many
results that extend beyond $J/\psi$ production in hadron collisions.
