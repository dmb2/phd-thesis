...
* The ATLAS detector
A Toroidal LHC AparatuS (ATLAS[fn:: ATLHCA doesn't have the same
ring, or status as a greek titan]) is one of the general purpose
detectors at the LHC. It is located at Point 1 on the LHC ring. Figure
...
will ionize the surrounding matter. In the former case, the radiation
can be detected directly, or it can produce a positron and electron
pair (pair production) which can subsequently detected. Different
parts of the detector exploit these two processes in different ways.
The electromagnetic and hadronic calorimeters work to stop electrons
and hadrons while accurately measuring the energy of the incident
