...
#+BEGIN_LaTeX
  \begin{figure}[htp]
    ...
    \subfloat[]{
      ...
      \includegraphics[width=0.5\textwidth]{figures/hcal-barrel-module-azimuth.pdf}
    }
    \subfloat[]{
     \includegraphics[width=0.4\textwidth]{figures/hcal-barrel-module.pdf}
...
#+BEGIN_LaTeX
  \begin{figure}[htp]
    ...
    \subfloat[]{
      ...
      \includegraphics[width=0.3\textwidth]{figures/ms_transverse.pdf}
    }
    \subfloat[]{
     \label{fig:ms-longitudinal}
     \includegraphics[width=0.7\textwidth]{figures/ms_longitudinal.pdf}
...
rate capability and time resolution \cite{atlas-detector}. 
