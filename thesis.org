...
** Inner Detector
Working radially outward from the IP, the ATLAS inner detector is
comprised of three main components: the pixel detector, the silicon
strip detector, and the transition radiation tracker (TRT).  
*** Pixel Detector
